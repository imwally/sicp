...
;; count-change procedure of Section 1.2.2 in the making change for 11
;; cents. What are the orders of growth of the space and numbers of
...
;; .               .
;; .                .
;; (cc 11 2)-----.  (cc 1 3)--------(cc -9 2)
;; .              .        `.
;; .               .         `------------------------------------------------------------------------------(cc 1 2)
;; (cc 11 1)---.   (cc 6 2)-----------------------------------------------------(cc 1 2)                    .      `.
;; .            .          `.                                                   .       `.                  .        `.
;; .             .           `.                                                 .         `.                (cc 1 1)   (cc -4 2)
;; (cc 11 0)     (cc 10 1)     (cc 6 1)--------------(cc 5 1)                   (cc 1 1)-.  (cc -4 2)       .      `.
;;               .       .             `.            .       `.                 `.        `.                .        `.
;;               .       .               `.          .         `.                 (cc 1 0)  (cc 0 1)        (cc 1 0)   (cc 0 1)
;;       (cc 10 0)       (cc 9 1)          (cc 6 0)  (cc 5 0)    (cc 4 1)
;;                       .      .                                .      .
;;                       .      .                                .      .  
